...
//INPUT
    ...
    let q4 = +document.getElementById("q4-in").value;
...
//PROCESS
  ...
  if (score === 5) {
    ...
    document.getElementById("response").innerHTML =
      "Good job! You are a super Ronaldo fan!";
    // 4/5
  } else if (score === 4) {
    ...
    document.getElementById("response").innerHTML =
      "nice try, you have decent knowledge.";
    // 2/5
  } else if (score === 2) {
    ...
    document.getElementById("response").innerHTML =
      "Yikes, You need to watch ronaldo more.";
    // 0/5
  } else {
